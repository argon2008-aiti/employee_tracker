...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'monitor_employee', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='/static/profile/default.png', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'GpsDevice.lastest_data'
        db.add_column(u'monitor_gpsdevice', 'lastest_data',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'monitor_employee', 'avatar')

        # Deleting field 'GpsDevice.lastest_data'
        db.delete_column(u'monitor_gpsdevice', 'lastest_data')
