...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SafetyManager'
        db.create_table(u'monitor_safetymanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Employee'], null=True)),
        ))
        db.send_create_signal(u'monitor', ['SafetyManager'])

        # Adding model 'GpsDevice'
        db.create_table(u'monitor_gpsdevice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identification_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('location', self.gf('djgeojson.fields.PointField')(null=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'monitor', ['GpsDevice'])
        ...
        # Changing field 'Alert.device'
        db.alter_column(u'monitor_alert', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.GpsDevice']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SafetyManager'
        db.delete_table(u'monitor_safetymanager')

        # Deleting model 'GpsDevice'
        db.delete_table(u'monitor_gpsdevice')


        # Changing field 'Employee.location_device'
        db.alter_column(u'monitor_employee', 'location_device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.GPS_Device'], null=True))

        # Changing field 'Alert.device'
        db.alter_column(u'monitor_alert', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.GPS_Device']))
    ...
    models = {
        ...
        u'monitor.employee': {
            ...
            'location_device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitor.GpsDevice']", 'null': 'True'}),
